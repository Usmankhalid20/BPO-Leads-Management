  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap justify-end gap-2">
        <Button variant="outline" onClick={() => updateStatus("CONTACTED")} disabled={saving || currentStatus === "CONTACTED"}>
          <CheckCircle2 className="h-4 w-4" />
          Mark as Contacted
        </Button>
        <Button variant="outline" onClick={() => updateStatus("CONVERTED")} disabled={saving || currentStatus === "CONVERTED"}>
